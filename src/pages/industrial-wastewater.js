        ...
        <div className="lg:absolute lg:inset-0">
          <div className="lg:absolute lg:inset-y-0 lg:left-0 lg:w-1/2">
            <div className="page-header-image-container">
              <img
                className="page-header-image h-56 w-full object-cover lg:absolute lg:h-full"
                src="/img/JG.png"
                alt=""
              />
            </div>

            <div className="page-header-text absolute inset-0 flex justify-center">
        ...
        <div className="relative z-10 py-12 px-4 sm:py-16 sm:px-6 lg:px-8 lg:max-w-7xl lg:mx-auto lg:grid lg:grid-cols-2">
          <div className="lg:col-start-2 lg:pl-8">
            <div className="text-base max-w-prose mx-auto lg:max-w-lg lg:ml-auto lg:mr-0">
              <h3 className="gothicblue-text text-600 mt-2 text-3xl leading-8 font-extrabold tracking-tight sm:text-4xl">
                We cater to the following industries: 
              </h3>
              <ul className="bullet-list list-disc mt-4 text-2xl text-gray-500">
              ...
              <div className="text-body mt-5 prose prose-indigo text-gray-500">
